    ...
    public class PessoaFromDTO {
        ...
        public PessoaFromDTO (
                Cargo cargo , String codigoReferencia , String cpf , String dataDeIngresso , String dataDeNascimento ,
                boolean doadorDeOrgaos , boolean doadorDeSangue , Escolaridade escolaridade , EstadoCivil estadoCivil ,
                String fatorRH , String fatorSanguineo , int id , String matricula , Localidade naturalidade ,
                String nomeCompleto , String foto , String apelido , String nomeDaMae , String nomeDoPai ,
                String observacoesAdicionais , int oidCargoQuadroSgp , int oidOmeSgp , int oidPessoaSgp ,
                boolean pessoaValidada , Quadro quadro , Religiao religiao , String rgCivil , String sexo
                             ) {
            this.cargo = cargo;
