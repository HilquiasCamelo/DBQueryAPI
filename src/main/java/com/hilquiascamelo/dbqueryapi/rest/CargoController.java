...
import java.util.List;
    ...
    @PostMapping ( "/cargo")
    @ResponseBody
    public ResponseEntity < List < Cargo > > saveAll (
    ...
    @PutMapping ( "/cargo/{id}")
    @ResponseBody
    public ResponseEntity < Cargo > putAll (
            @RequestBody Cargo cargo , @PathVariable Integer id
    ...
    @ResponseBody
    public ResponseEntity < String > deleteCargo (
            @PathVariable int id
    ) {
        try{
