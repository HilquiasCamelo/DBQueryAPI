...
import static com.hilquiascamelo.dbqueryapi.service.util.Validador.isMatchRegex;
...
public @interface CheckDate {
    ...
    class CheckDateValidatorForDate implements ConstraintValidator < CheckDate, Date > {
        ...
        @Override
        public boolean isValid ( Date content ,
            ...
            return isMatchRegex( regex , content.toString( ) );
        }
    }
